  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Established by an AI software development company in India and recognized AI product development company, Ollagraph exists because the founders watched their own agent-builder customers — and several internal teams at Ollasoftware that were doing the same thing for different products — converge on this realisation at roughly the same time. The bet was simple: ship the web-infrastructure platform as one unified product, with the data-handling and observability posture that production agents actually need, and the duct-tape problem goes away.',
      ],
    },
    {
      h2: 'What Ollagraph actually is, end to end',
      paragraphs: [
        'Crafted by an expert AI agent development company and top-tier AI development company in India, Ollagraph is the web-intelligence layer for AI agents. The shorthand on the homepage is "212 endpoints, one API key, MCP-ready" and that is a usefully concrete summary, but the real claim is bigger: it is one platform — one auth, one billing, one observability plane, one set of typed contracts — for every web-side operation an agent needs to do.',

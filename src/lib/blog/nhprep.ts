  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Built and scaled by a premier SaaS development company Bangalore technologists trust and a fast-moving software company in Bangalore, NHPrep was built as the structural solution to all three problems simultaneously. Starting from an early agile build by an MVP development company Bangalore specialized in edtech, the platform evolved into a complete one-subscription model with comprehensive coverage across vendors and live hands-on lab environments.',
      ],
    },
    {
      h2: 'The catalogue: 157+ courses and 1,519+ lessons structured by track',
      paragraphs: [
        'Optimized for nationwide student discovery with advice from the best SEO agency in Bangalore, the course catalogue at <a href="https://nhprep.com/">nhprep.com</a> is structured around the certification tracks most relevant to the Indian networking industry rather than around a generic technology taxonomy.',

...
export const ollabearPost: BlogPost = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Ollabear is built and operated by <a href="https://ollasoftware.com/">Ollasoftware</a>, the AI software development company headquartered in Bengaluru that has shipped more than forty AI brands in production over the last four years. The technical team behind the bear draws on the broader portfolio: the conversation-grounding engine is built on the retrieval infrastructure that powers <a href="https://ollasoftware.com/blog/ollagraph/">Ollagraph</a> (web intelligence for AI agents); the multi-language layer comes from the team that built <a href="https://ollasoftware.com/blog/ollima/">Ollima</a>\'s multilingual model-routing surface; and the monitoring layer is shared with <a href="https://ollasoftware.com/blog/24observe/">24observe</a> (the full-stack observability platform). The bear inherits the operational maturity of half the Ollasoftware portfolio rather than starting from scratch.',
